// from https://github.com/Stanko/html-canvas-video-player/blob/gh-pages/js/canvas-video-player.js
...
var CanvasVideoPlayer = function(options) {
  ...
  this.options = {
    ...
    loop: false,
    waitForMetaDataBeforeResizing: false
  };
...
CanvasVideoPlayer.prototype.init = function() {
  ...
  if(this.options.waitForMetaDataBeforeResizing) {
    this.video.onloadedmetadata = function() {
      that.setCanvasSize(this.offsetWidth, this.offsetHeight);

      if (that.options.hideVideo) {
